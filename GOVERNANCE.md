...
This governance model aims to create an open source community that encourages transparency, contributions, and collaboration, but maintains sound technical and quality standards. Our goal is to build a community comprised of members across the OCO-2 CAR community and beyond, including from private organizations, universities, government organizations, and international organizations. 
...
Anyone who has downloaded, deployed, or operated OCO-2 CAR code to meet a specific objective.  
...
Overall manager of the project with final authority over all key decisions. Currently these are the OCO-2 CAR developers. They will serve in the Product Manager role through the end of the OCO-2 mission and be the final authortiy on decisions. After that time, roles for this may be reassessed.
